...
const selectSchema = (num) => {
  return num === 1 ? addProgramSchema : num === 2 ? getProgramsSchema
  : num === 3 ? getProgramSchema : removeProgramSchema;
}
...
prompt.get(schema, (err, result) => {
  prompt.get(selectSchema(+result.method), (err, input) => {
